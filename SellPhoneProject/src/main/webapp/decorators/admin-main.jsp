...
<html>
<head>
    <title><dec:title default="${ pageContext.request.contextPath}"/></title>
...
<div class="wrapper">
    <div class="sidebar" data-color="purple" data-image="<c:url value="/resources/assets/img/sidebar-5.jpg"/>">
