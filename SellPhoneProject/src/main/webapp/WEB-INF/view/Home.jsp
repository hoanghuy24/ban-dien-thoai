						...
						<c:forEach var="product" items="${listProductHightLight}">
							<div class="col-md-4">
								<div class="item text-center">
									<a
										href="${ product.getCategory().getCategory().toLowerCase()}/${ product.getCode() }-${ product.getId()}"><img
										src="${ product.getImage() }" width="270px" height="150px"
										alt="ảnh điện thoại"></a>
									<p class="ten-san-pham">
										<b><a
											href="${ product.getCategory().getCategory().toLowerCase()}/${ product.getCode() }-${ product.getId()}">${ product.getName() }</a></b>
									</p>
									<p>
